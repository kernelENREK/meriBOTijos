...
{
    public partial class Bot_Mercadillo_Retro : System.Web.UI.Page
    {
        #region Fields para el Mercadillo Apartado Consolas -> Retro
        ...
        private const bool _esMercadillo = true;
        private const string _ForumDesc = "Mercadillo: Retro";
        private const int _ForumID = 6360;
        private const string _prefixTweet = "[Retro]";

        // Especificos para el Bot @Nombre_de_tu_cuenta_BOTijo_de_Twitter_para_Mercadillo
